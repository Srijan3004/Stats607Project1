...
data = read.csv("/Users/srijan/Documents/Academic_Stuffs/BStat/B3_resources/ass_or_hw/Stat Compre/Final Project/Initial Data/rainfall.csv")
...
#write.csv(full_data, "/Users/srijan/Documents/Academic_Stuffs/Dis_stuff/full_data_wb.csv")
full_data = read.csv("/Users/srijan/Documents/Academic_Stuffs/Dis_stuff/full_data_wb.csv")[,-1]
...
ggsave("/Users/srijan/Documents/Academic_Stuffs/Dis_stuff/Plots/year_month_station_wise_missing_count.pdf",width = 10.63, height = 8.13)
...
ggsave("/Users/srijan/Documents/Academic_Stuffs/Dis_stuff/Plots/year_month_daily_station_wise_missing_count.pdf",width = 10.63, height = 8.13)
...
ggsave("/Users/srijan/Documents/Academic_Stuffs/Dis_stuff/Plots/stationwise_count_map.pdf",width = 7.63, height = 8.13)
...
ggsave("/Users/srijan/Documents/Academic_Stuffs/Dis_stuff/Plots/stationwise_rainfall_years.pdf",width = 16, height = 7)
...
ggsave("/Users/srijan/Documents/Academic_Stuffs/Dis_stuff/Plots/MA/trend_alipur.pdf",width = 7, height =7)
...
ggsave("/Users/srijan/Documents/Academic_Stuffs/Dis_stuff/Plots/MA/seasonality_alipur.pdf",width = 7, height = 7)
...
ggsave("/Users/srijan/Documents/Academic_Stuffs/Dis_stuff/Plots/MA/trend_malda.pdf",width = 7, height =7) 
...
ggsave("/Users/srijan/Documents/Academic_Stuffs/Dis_stuff/Plots/MA/seasonality_malda.pdf",width = 7, height =7) 
...
ggsave("/Users/srijan/Documents/Academic_Stuffs/Dis_stuff/Plots/MA/trend_midnapore.pdf",width = 7, height =7) 
...
ggsave("/Users/srijan/Documents/Academic_Stuffs/Dis_stuff/Plots/MA/seasonality_midnapore.pdf",width = 7, height =7) 
...
pdf("Documents/Academic_Stuffs/Dis_stuff/Plots/Trend_SS_Pred_for_Smooth_TS.pdf", width = 18, height = 10)
for(i in seq_len(nStn)){
...
pdf("Documents/Academic_Stuffs/Dis_stuff/Plots/Trend_SS_Pred_for_Smooth_TS_reflecting_boundary.pdf", width = 18, height = 10)
for(i in seq_len(nStn)){
...
### Only doing for some specific stations now
## Alipur
i = 72
st_type <- as.character(spat_full_data[i, 4])
mat <- mse_arr[i,,]
...
plot_data <- data.frame(
    ...
    smooth_pred = smooth_pred,
    smooth_trend = smooth_trend,
    ma_pred = MA_pred_alipur,
    ma_trend = c(rep(NA,179), MA_trend_alipur, rep(NA,180))
)
rmse_TS <- sqrt(mean((plot_data$Actual - plot_data$TrendSSPenalty)^2, na.rm = TRUE))
mae_TS  <- mean(abs(plot_data$Actual - plot_data$TrendSSPenalty), na.rm = TRUE)
rmse_smooth <- sqrt(mean((plot_data$Actual - plot_data$smooth_pred)^2, na.rm = TRUE))
mae_smooth  <- mean(abs(plot_data$Actual - plot_data$smooth_pred), na.rm = TRUE)
rmse_ma <- sqrt(mean((plot_data$Actual - plot_data$ma_pred)^2, na.rm = TRUE))
mae_ma <- mean(abs(plot_data$Actual - plot_data$ma_pred), na.rm = TRUE)
sd1_TS = round(sd(penalty_seasonality_diffpen$V1, na.rm = TRUE), 2)
sd2_TS = round(sd(penalty_seasonality_diffpen$V2, na.rm = TRUE), 2)
sd3_TS = round(sd(penalty_seasonality_diffpen$V3, na.rm = TRUE), 2)
sd4_TS = round(sd(penalty_seasonality_diffpen$V4, na.rm = TRUE), 2)
...
sd3_smooth = round(sd(smooth_seasonality$V3,na.rm = TRUE),2)
sd4_smooth = round(sd(smooth_seasonality$V4,na.rm = TRUE),2)
sd1_ma = round(sd(MA_season_alipur$time1,na.rm = TRUE),2)
sd2_ma = round(sd(MA_season_alipur$time2,na.rm = TRUE),2)
sd3_ma = round(sd(MA_season_alipur$time3,na.rm = TRUE),2)
sd4_ma = round(sd(MA_season_alipur$time4,na.rm = TRUE),2)
p1 = ggplot(penalty_seasonality_diffpen) +
    geom_line(aes(x = 1:12, y = V1, colour = "1901-1930"), linewidth = 1.2) +
    geom_line(aes(x = 1:12, y = V2, colour = "1931-1960"), linewidth = 1.2) +
    geom_line(aes(x = 1:12, y = V3, colour = "1961-1990"), linewidth = 1.2) +
...
p3 = MA_season_alipur %>%
  ggplot() +
  geom_line(aes(x = 1:12, y = time1, colour = "1901-1930"), linewidth = 1.2) +
  geom_line(aes(x = 1:12, y = time2, colour = "1931-1960"), linewidth = 1.2) +
  geom_line(aes(x = 1:12, y = time3, colour = "1961-1990"), linewidth = 1.2) +
  geom_line(aes(x = 1:12, y = time4, colour = "1991-2020"), linewidth = 1.2) +
  labs(
    x = "Months", 
    y = "Seasonality", 
    title = paste("MA Seasonality Estimate for", spat_full_data[i, 3]),
    subtitle = paste0(
      "SD 1st: ", sd1_ma,
      " | 2nd: ", sd2_ma,
      " | 3rd: ", sd3_ma,
...
p6 <- ggplot(plot_data, aes(x = x)) +
  geom_line(aes(y = Actual, color = "Actual"), linewidth = 1.3, alpha = 0.95) +
  geom_line(aes(y = ma_pred, color = "Predicted"), linewidth = 1, alpha = 0.6) + 
  labs(
    title = paste("MA Prediction vs Actual for", spat_full_data[i, 3]),
    subtitle = paste("RMSE:", round(rmse_ma, 2), "| MAE:", round(mae_ma, 2)),
    x = "Index",
    y = "Value",
    color = "Method"
  ) +
...
p7 <- ggplot(plot_data, aes(x = x)) +
    geom_line(aes(y = TrendSSPenalty_trend, color = "TS"), linewidth = 1) +
    geom_line(aes(y = smooth_trend, color = "Smoothing"), linewidth = 1) + 
   geom_line(aes(y = ma_trend, color = "MA"), linewidth = 1) +
    labs(
      title = paste("Trend Estimates for ", spat_full_data[i, 3]),
      x = "Index",
      y = "Value",
...
ggsave("/Users/srijan/Documents/Academic_Stuffs/Dis_stuff/Plots/Alipur/trend.pdf", p7, width = 9, height =7)
ggsave("/Users/srijan/Documents/Academic_Stuffs/Dis_stuff/Plots/Alipur/ma_seasonality.pdf", p3, width = 9, height = 9)
ggsave("/Users/srijan/Documents/Academic_Stuffs/Dis_stuff/Plots/Alipur/smooth_seasonality.pdf", p2, width = 9, height =9)
ggsave("/Users/srijan/Documents/Academic_Stuffs/Dis_stuff/Plots/Alipur/TS_seasonality.pdf", p1, width = 9, height =9)
ggsave("/Users/srijan/Documents/Academic_Stuffs/Dis_stuff/Plots/Alipur/TS_predvsactual.pdf", p4, width = 12, height =7)
ggsave("/Users/srijan/Documents/Academic_Stuffs/Dis_stuff/Plots/Alipur/smooth_predvsactual.pdf", p5, width = 12, height =7)
ggsave("/Users/srijan/Documents/Academic_Stuffs/Dis_stuff/Plots/Alipur/ma_predvsactual.pdf", p6, width = 12, height =7)



residual_ma_alipur = plot_data$Actual - plot_data$ma_pred
residual_ma_alipur[is.na(residual_ma_alipur)] = 0
pdf(
  "/Users/srijan/Documents/Academic_Stuffs/Dis_stuff/Plots/Alipur/ma_residual.pdf",
  width = 9,
  height = 7
)
...
title("ACF of Residuals (Alipur)", line = 1)
...
plot_data <- data.frame(
  ...
  smooth_pred = smooth_pred,
  smooth_trend = smooth_trend,
  ma_pred = c(rep(NA,179), MA_pred_malda, rep(NA,180)),
  ma_trend = c(rep(NA,179), MA_trend_malda, rep(NA,180))
)
rmse_TS <- sqrt(mean((plot_data$Actual - plot_data$TrendSSPenalty)^2, na.rm = TRUE))
mae_TS  <- mean(abs(plot_data$Actual - plot_data$TrendSSPenalty), na.rm = TRUE)
rmse_smooth <- sqrt(mean((plot_data$Actual - plot_data$smooth_pred)^2, na.rm = TRUE))
...
sd3_smooth = round(sd(smooth_seasonality$V3,na.rm = TRUE),2)
sd4_smooth = round(sd(smooth_seasonality$V4,na.rm = TRUE),2)
sd1_ma = round(sd(MA_season_malda$time1,na.rm = TRUE),2)
sd2_ma = round(sd(MA_season_malda$time2,na.rm = TRUE),2)
sd3_ma = round(sd(MA_season_malda$time3,na.rm = TRUE),2)
sd4_ma = round(sd(MA_season_malda$time4,na.rm = TRUE),2)
p1 = ggplot(penalty_seasonality_diffpen) +
  geom_line(aes(x = 1:12, y = V1, colour = "1901-1930"), linewidth = 1.2) +
  geom_line(aes(x = 1:12, y = V2, colour = "1931-1960"), linewidth = 1.2) +
  geom_line(aes(x = 1:12, y = V3, colour = "1961-1990"), linewidth = 1.2) +
...
ggsave("/Users/srijan/Documents/Academic_Stuffs/Dis_stuff/Plots/Malda/trend.pdf", p7, width = 9, height =7)
ggsave("/Users/srijan/Documents/Academic_Stuffs/Dis_stuff/Plots/Malda/ma_seasonality.pdf", p3, width = 9, height = 9)
ggsave("/Users/srijan/Documents/Academic_Stuffs/Dis_stuff/Plots/Malda/smooth_seasonality.pdf", p2, width = 9, height =9)
ggsave("/Users/srijan/Documents/Academic_Stuffs/Dis_stuff/Plots/Malda/TS_seasonality.pdf", p1, width = 9, height =9)
ggsave("/Users/srijan/Documents/Academic_Stuffs/Dis_stuff/Plots/Malda/TS_predvsactual.pdf", p4, width = 12, height =7)
ggsave("/Users/srijan/Documents/Academic_Stuffs/Dis_stuff/Plots/Malda/smooth_predvsactual.pdf", p5, width = 12, height =7)
ggsave("/Users/srijan/Documents/Academic_Stuffs/Dis_stuff/Plots/Malda/ma_predvsactual.pdf", p6, width = 12, height =7)


residual_ma_malda = plot_data$Actual - plot_data$ma_pred
residual_ma_malda[is.na(residual_ma_malda)] = 0
pdf(
  "/Users/srijan/Documents/Academic_Stuffs/Dis_stuff/Plots/Malda/ma_residual.pdf",
  width = 9,
  height = 7
)
...
title("ACF of Residuals (Malda)", line = 1)
...
plot_data <- data.frame(
  ...
  smooth_pred = smooth_pred,
  smooth_trend = smooth_trend,
  ma_pred = c(rep(NA,179), MA_pred_midnpore, rep(NA,180)),
  ma_trend = c(rep(NA,179), MA_trend_midnapore, rep(NA,180))
)
rmse_TS <- sqrt(mean((plot_data$Actual - plot_data$TrendSSPenalty)^2, na.rm = TRUE))
mae_TS  <- mean(abs(plot_data$Actual - plot_data$TrendSSPenalty), na.rm = TRUE)
rmse_smooth <- sqrt(mean((plot_data$Actual - plot_data$smooth_pred)^2, na.rm = TRUE))
...
sd3_smooth = round(sd(smooth_seasonality$V3,na.rm = TRUE),2)
sd4_smooth = round(sd(smooth_seasonality$V4,na.rm = TRUE),2)
sd1_ma = round(sd(MA_season_midnapore$time1,na.rm = TRUE),2)
sd2_ma = round(sd(MA_season_midnapore$time2,na.rm = TRUE),2)
sd3_ma = round(sd(MA_season_midnapore$time3,na.rm = TRUE),2)
sd4_ma = round(sd(MA_season_midnapore$time4,na.rm = TRUE),2)
p1 = ggplot(penalty_seasonality_diffpen) +
  geom_line(aes(x = 1:12, y = V1, colour = "1901-1930"), linewidth = 1.2) +
  geom_line(aes(x = 1:12, y = V2, colour = "1931-1960"), linewidth = 1.2) +
  geom_line(aes(x = 1:12, y = V3, colour = "1961-1990"), linewidth = 1.2) +
...
ggsave("/Users/srijan/Documents/Academic_Stuffs/Dis_stuff/Plots/Midnapore/trend.pdf", p7, width = 9, height =7)
ggsave("/Users/srijan/Documents/Academic_Stuffs/Dis_stuff/Plots/Midnapore/ma_seasonality.pdf", p3, width = 9, height = 9)
ggsave("/Users/srijan/Documents/Academic_Stuffs/Dis_stuff/Plots/Midnapore/smooth_seasonality.pdf", p2, width = 9, height =9)
ggsave("/Users/srijan/Documents/Academic_Stuffs/Dis_stuff/Plots/Midnapore/TS_seasonality.pdf", p1, width = 9, height =9)
ggsave("/Users/srijan/Documents/Academic_Stuffs/Dis_stuff/Plots/Midnapore/TS_predvsactual.pdf", p4, width = 12, height =7)
ggsave("/Users/srijan/Documents/Academic_Stuffs/Dis_stuff/Plots/Midnapore/smooth_predvsactual.pdf", p5, width = 12, height =7)
ggsave("/Users/srijan/Documents/Academic_Stuffs/Dis_stuff/Plots/Midnapore/ma_predvsactual.pdf", p6, width = 12, height =7)
...
ggsave("/Users/srijan/Documents/Academic_Stuffs/Dis_stuff/Plots/Hooghly/trend.pdf", p5, width = 9, height =7)
ggsave("/Users/srijan/Documents/Academic_Stuffs/Dis_stuff/Plots/Hooghly/smooth_seasonality.pdf", p2, width = 9, height =9)
ggsave("/Users/srijan/Documents/Academic_Stuffs/Dis_stuff/Plots/Hooghly/TS_seasonality.pdf", p1, width = 9, height =9)
ggsave("/Users/srijan/Documents/Academic_Stuffs/Dis_stuff/Plots/Hooghly/TS_predvsactual.pdf", p3, width = 12, height =7)
ggsave("/Users/srijan/Documents/Academic_Stuffs/Dis_stuff/Plots/Hooghly/smooth_predvsactual.pdf", p4, width = 12, height =7)


##### weights analysis
weights_smoothing = function(station_cur_ind,t,df,h,knn){
  dist_station_cur = numeric()
  for(i in 1:nrow(spat_full_data)){
    dist_station_cur[i] = spatial_dist(station_cur_ind,i)
  }
  ...
  A = Reduce('+',a_list)
  mult = t(trend_ss_basis[t,]) %*% solve(t(A)%*%A) %*% t(A)
  weight_mat = matrix(0,nrow = nrow(spat_full_data), ncol = 1440)
  t0_ind = t0$indicator
  for(j in 1:1440){
    weight_mat[station_cur_ind,j] =  (1/h) * 1/(sqrt(2*pi)) * t0_ind[j] * (mult%*%trend_ss_basis[j,])
  }
  for(u in 1:knn){
    t_u = trend_ss_matrix(nearest_station_cur[u], df)
    w_u = t_u$indicator
    k_u = (1/h) * 1/(sqrt(2*pi)) * exp(-((sorted_distances[u+1]/h)^2)/2)
    for(j in 1:1440){
      weight_mat[nearest_station_cur[u],j] = (w_u[j]*k_u)*(mult%*%trend_ss_basis[j,])
    }
  }
  return(list(weight_mat = weight_mat, nbh = nearest_station_cur))
}


common_sum_diffpenalty = function(df,lambda1, lambda2, type){
  F1 = 0
  check = ifelse(spat_full_data$region == type,1,0)
  check_ind = which(check == 1)
...
weights_diffpenalty = function(s, t, df, lambda1, lambda2, FF1_reg){
  type =as.character(spat_full_data[s,4])
  tot_info = common_sum_diffpenalty(df, lambda1, lambda2, type)
  info_s = EE1E2_s_diffpenalty(s,df,lambda1,lambda2)
  L = diag(c(rep(lambda1,df),rep(lambda2,(nrow(info_s$Es)-df))))
  mult = t(trend_ss_basis[t,])%*%solve(info_s$Es)%*%L%*%solve(tot_info)
  weight_mat = matrix(0,nrow = nrow(spat_full_data), ncol = 1440)
  for(u in 1:nrow(spat_full_data)){
    t_u = trend_ss_matrix(u, df)
    w_u = t_u$indicator
    info_u = EE1E2_s_diffpenalty(u,df,lambda1,lambda2)$Es
    mult_u = mult%*%solve(info_u)
    for(j in 1:1440){
      weight_mat[u,j] = w_u[j] * (mult_u%*%trend_ss_basis[j,])
    }
  }
  w_s = trend_ss_matrix(nearest_station_cur[u], df)$indicator
  weight_mat[s,t] = weight_mat[s,t] +  w_s[t] * t(trend_ss_basis[t,])%*%solve(info_s$Es)%*%trend_ss_basis[t,]
  nbh = which(spat_full_data[,4]==type)
  return(list(weight_mat = weight_mat, nbh = nbh))
}


prepare_data <- function(row_index, mat1, mat2) {
  data.frame(
    x = 1:ncol(mat1),
    value1 = mat1[row_index, ],
    value2 = mat2[row_index, ]
  ) %>%
    pivot_longer(cols = starts_with("value"),
                 names_to = "Method",
                 values_to = "Value") %>%
    mutate(Method = recode(Method, value1 = "TS Penalty", value2 = "Smooth"),
           Row = paste("Row", row_index))
}
...
var_pred = numeric()
for(j in 1:nrow(which_idx)){
  key <- paste(type, which_idx[j,1], which_idx[j,2], sep = "_")
  FF1_mat <- FF1_cache[[key]]
  ts = trend_ss_estimate_ind_diffpenalty_train_test(i,8,lambda_seq[which_idx[j,1]],lambda_seq[which_idx[j,2]],FF1_mat)
  var_pred[j] = var(ts$predicted)
}
j_min = which.min(var_pred)
lambda1 = lambda_seq[which_idx[j_min,1]]
lambda2 = lambda_seq[which_idx[j_min,2]]
key <- paste(st_type, which_idx[j_min,1], which_idx[j_min,2], sep = "_")
FF1_mat <- FF1_cache[[key]] 
t = 200
w_d_72_200 = weights_diffpenalty(s,t,8,lambda1,lambda2,FF1_mat)
w_s_72_200 = weights_smoothing(s,t,8,20,9)

union_index = union(w_s_72_200$nbh,w_d_72_200$nbh)



plot_data_list <- lapply(union_index, function(i) prepare_data(i, w_d_72_200$weight_mat, w_s_72_200$weight_mat))

plot_list <- lapply(plot_data_list, function(df) {
  ggplot(df, aes(x = x, y = Value, color = Method)) +
    geom_line(size = 1.2) +
    labs(title = unique(df$Row), x = "Column Index", y = "Value") +
    scale_color_manual(values = c("TS Penalty" = "blue", "Smooth" = "red")) +
    theme_minimal()
})

pdf("/Users/srijan/Documents/Academic_Stuffs/Dis_stuff/Plots/weights_72_200.pdf", width = 6, height = 4)
for (p in plot_list) {
  print(p)
}
dev.off()
...
#### map prediction
trend_mx_allstation_diffpenalty = matrix(NA,nrow = nrow(spat_full_data),ncol=1440)
pred_rain_all_station_diffpenalty = matrix(NA,nrow = nrow(spat_full_data),ncol=1440)
trend_mx_all_station_smooth = matrix(NA,nrow = nrow(spat_full_data),ncol=1440)
pred_rain_all_station_smooth = matrix(NA,nrow = nrow(spat_full_data),ncol=1440)
for(i in 1:nrow(spat_full_data)) {
  if (is.na(sum(mse_arr_ext[i,,]))==FALSE && !inherits(try(trend_ss_estimate_smoothing(i, 8, mse_h_ts[i], 9), silent=TRUE), "try-error") && is.na(mse_h_ts[i]) == FALSE ) {
  type <- spat_full_data[i, 4]
  mat <- mse_arr_ext[i,,]
  vec <- as.vector(mat)
  vmin <- min(vec)
  q <- quantile(vec, 0.1)
  ...
  key <- paste(st_type, which_idx[j_min,1], which_idx[j_min,2], sep = "_")
  FF1_mat <- FF1_cache[[key]] 
  penalty_result_diffpen = trend_ss_estimate_ind_diffpenalty(i,8,lambda1,lambda2,FF1_mat)
  smooth_result = trend_ss_estimate_smoothing(i,8,mse_h_ts[i],9)
  diffpenalty_trend <- penalty_result_diffpen$trend
  diffpenalty_pred <- penalty_result_diffpen$predicted
  smooth_trend = smooth_result$trend
  smooth_pred = smooth_result$predicted
  trend_mx_allstation_diffpenalty[i,] = diffpenalty_trend
  pred_rain_all_station_diffpenalty[i,] = diffpenalty_pred
  trend_mx_all_station_smooth[i,] = smooth_trend
  pred_rain_all_station_smooth[i,] = smooth_pred
  print(i)
  }
}
...
month_year_labels <- as.vector(t(outer(years, months, paste, sep = "-")))
india <- ne_states(country = "India", returnclass = "sf")
west_bengal <- india %>% filter(name == "West Bengal")


pdf("Documents/Academic_Stuffs/Dis_stuff/Plots/trend_all_station_diffpenalty.pdf", width = 18, height = 10)  # landscape mode
n_plots <- ncol(trend_mx_allstation_diffpenalty)

trend_mx_allstation_diffpenalty[trend_mx_allstation_diffpenalty < 0] <- NA
global_min <- min(trend_mx_allstation_diffpenalty, na.rm = TRUE)
global_max <- max(trend_mx_allstation_diffpenalty, na.rm = TRUE)
...
for (i in seq(1, n_plots, by = 12)) {
  ...
  for (j in 1:12) {
    ...
    plot_data <- spat_full_data %>%
      mutate(rainfall = as.numeric(trend_mx_allstation_diffpenalty[,idx]))
    
    # Convert to sf
    stations_sf <- st_as_sf(plot_data, coords = c("longitude", "latitude"), crs = 4326)
    
    # Create the plot
    p <- ggplot() +
      geom_sf(data = west_bengal, fill = "gray95", color = "black") +
      geom_sf(data = stations_sf, aes(color = rainfall), size = 2) +
      scale_color_viridis_c(
        option = "turbo", 
        name = "Rainfall (mm)",
        limits = c(global_min, global_max),
        oob = scales::squish  # ensures values outside range don't cause errors
      ) +
      labs(title = paste("Rainfall -", month_year_labels[idx])) +
      theme_minimal() +
      theme(
  ...
  # Arrange 12 plots per page (3x4 grid)
...
pdf("Documents/Academic_Stuffs/Dis_stuff/Plots/pred_rain_all_station_diffpenalty.pdf", width = 18, height = 10)  # landscape mode
n_plots <- ncol(pred_rain_all_station_diffpenalty)

pred_rain_all_station_diffpenalty[pred_rain_all_station_diffpenalty < 0] <- NA
global_min <- min(pred_rain_all_station_diffpenalty, na.rm = TRUE)
global_max <- max(pred_rain_all_station_diffpenalty, na.rm = TRUE)
...
for (i in seq(1, n_plots, by = 12)) {
  ...
  for (j in 1:12) {
    ...
    if (idx > n_plots) break
    plot_data <- spat_full_data %>%
      mutate(rainfall = as.numeric(pred_rain_all_station_diffpenalty[,idx]))
...
pdf("Documents/Academic_Stuffs/Dis_stuff/Plots/trend_all_station_smooth.pdf", width = 18, height = 10)  # landscape mode
n_plots <- ncol(trend_mx_all_station_smooth)

trend_mx_all_station_smooth[trend_mx_all_station_smooth < 0] <- NA
global_min <- min(trend_mx_all_station_smooth, na.rm = TRUE)
global_max <- max(trend_mx_all_station_smooth, na.rm = TRUE)
...
for (i in seq(1, n_plots, by = 12)) {
  ...
  for (j in 1:12) {
    ...
    if (idx > n_plots) break
    plot_data <- spat_full_data %>%
      mutate(rainfall = as.numeric(trend_mx_all_station_smooth[,idx]))
...
pdf("Documents/Academic_Stuffs/Dis_stuff/Plots/pred_rain_all_station_smooth.pdf", width = 18, height = 10)  # landscape mode
n_plots <- ncol(pred_rain_all_station_smooth)

pred_rain_all_station_smooth[pred_rain_all_station_smooth < 0] <- NA
global_min <- min(pred_rain_all_station_smooth, na.rm = TRUE)
global_max <- max(pred_rain_all_station_smooth, na.rm = TRUE)
...
for (i in seq(1, n_plots, by = 12)) {
  ...
  for (j in 1:12) {
    ...
    if (idx > n_plots) break
    plot_data <- spat_full_data %>%
      mutate(rainfall = as.numeric(pred_rain_all_station_smooth[,idx]))
